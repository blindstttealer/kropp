      ...
      <div className="footer-main-inner container">
        ...
        <div className="footer-body">
          ...
          <div className="footer-column">
            ...
            <address className="footer-column-address">
              ...
              <div className="footer-contacts">
                <ul className="footer-contacts-list">
                  ...
                  <li className="footer-contacts-item">
                    <a href="tel:+17184076400" className="footer-contacts-link">
                      + (1) 718 - 407 - 6400
                    </a>
                  </li>
                </ul>
            ...
            <div className="footer-socials">
              <ul className="footer-socials-list">
                <li className="footer-socials-item">
                  <a target="_blank" href="/" className="footer-socials-link">
                    <svg
                      viewBox="0 0 24 24"
                      fill="none"
                ...
                <li className="footer-socials-item">
                  <a target="_blank" href="/" className="footer-socials-link">
                    <svg viewBox="-5 0 20 20" version="1.1">
                      <g
                        id="Page-1"
                        stroke="none"
                        strokeWidth="1"
